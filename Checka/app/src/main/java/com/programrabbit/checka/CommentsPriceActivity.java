...
public class CommentsPriceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comments_price);
        ...
        if(isAdmin){
            ...
            priceDatabaseReference.child(key+"/comments").addListenerForSingleValueEvent(new ValueEventListener() {
