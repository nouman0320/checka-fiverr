...
public class CommentsServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comments_service);
        ...
        if(isAdmin){
            ...
            serviceDatabaseReference.child(key+"/comments").addListenerForSingleValueEvent(new ValueEventListener() {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                temp.addAll(service.getComments());
